...
The contract renames a constant declaration and fetches whose owner can be resolved statically.
Dynamic owners require review; inherited fetches through child class names remain outside the
observable envelope. Stale sources, declaration collisions, and ambiguous evidence fail closed.
